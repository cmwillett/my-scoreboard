    ...
    html: `
      <div class="help-modal-content">
        ...
        <section>
          ...
          <ul>
            <li><strong>v0.8.9</strong> De-duplicated followed teams that are in the same game and uses Auto Refresh/In Season settings to hide out-of-season followed teams.</li>
            ...
            <li><strong>v0.8.9</strong> Added Help / Change Log and per-page display density.</li>
